...
def calculate(pred_file, ref_file, mode, model):
    ...
    return score_dict, scores,(bleu_scores, f1, mover_scores)
...
if __name__ == '__main__':
    ...
    hyp_paths = {
                 "ISM":"/data-xxx/xxx/IGMS_checkpoints/mmss_f4_LDec/hyp_precisionV2_Org_16.txt",
                 "cfsum":"/data-xxx/data/xxx/ReAttnMMS_checkpoints/1206-c2-ot-l6l9l3/hyps/hyp12.txt"
                 }
    import csv
    ...
    # hyp_paths = {"UniG":"/data/xxx/ReAttnMMS_checkpoints/1114-en-train/hyps/hyp_model_32.txt"
    #              }
    ref_path = "/data-xxx/data/xxx/dataset/MMS/corpus/test_title.txt"
    all_score = []
